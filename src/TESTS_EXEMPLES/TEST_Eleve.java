 ...
 * @author HP Pavilion
 */
public class TEST_Eleve implements InterfaceEleve{
    ...
    public TEST_Eleve(int id, int idEntreprise, int idUtilisateur, int idExercice, int idClasse, long signature, String classe, String adresse, String telephonesParents, String nom, String postnom, String prenom, String lieuNaissance, int sexe, Date dateNaissance) {
        this.id = id;
