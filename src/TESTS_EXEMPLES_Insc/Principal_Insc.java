...
public class Principal_Insc extends javax.swing.JFrame {
    ...
    public ParametreInscription getParametres() {
        ...
        this.Frais_Inscription = new Frais(12, utilisateur.getId(), entreprise.getId(), anneescolaire.getId(), 10, 50, "INSCRIPTION", "$", 1010101010, UtilInscription.generateSignature(), InterfaceFrais.BETA_EXISTANT);
        ...
        this.Frais_Inscription.setLiaisonsClasses(liaisonsINSCRIPTION);
        this.Frais_Inscription.setLiaisonsPeriodes(new Vector<LiaisonFraisPeriode>());
        ...
        this.Frais_Minervale = new Frais(1, utilisateur.getId(), entreprise.getId(), anneescolaire.getId(), 10, 1500, "MINERVALE", "$", 1010101010, UtilInscription.generateSignature(), InterfaceFrais.BETA_EXISTANT);
        ...
        this.Frais_Minervale.setLiaisonsClasses(liaisonsMINERVALE);
        this.Frais_Minervale.setLiaisonsPeriodes(new Vector<LiaisonFraisPeriode>());
        ...
        this.Frais_TravailManul = new Frais(1, utilisateur.getId(), entreprise.getId(), anneescolaire.getId(), 10, 10, "TRAVAIL MANUEL", "$", 1010101010, UtilInscription.generateSignature(), InterfaceFrais.BETA_EXISTANT);
        ...
        this.Frais_TravailManul.setLiaisonsClasses(liaisonsTRAVAILMAN);
        this.Frais_TravailManul.setLiaisonsPeriodes(new Vector<LiaisonFraisPeriode>());
