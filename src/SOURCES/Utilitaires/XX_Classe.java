 ...
 * @author HP Pavilion
 */
public class XX_Classe implements InterfaceClasse{
    public int id;
    ...
    public XX_Classe(int id, int idUtilisateur, int idEntreprise, int idExercice, String nom, int capacite, String nomLocal, long signature) {
        this.id = id;
